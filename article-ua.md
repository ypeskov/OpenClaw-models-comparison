# Я протестував 8 AI-моделей як автономних агентів. Половина завалила просте завдання з 4 кроків.
...
Детальні результати по кожній моделі (з точними висновками, розбивкою оцінок та нотатками про поведінку) — на: [GitHub](https://github.com/ypeskov/OpenClaw-models-comparison)
