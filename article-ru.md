...
Подробные описания задач 2–5 с системой оценки — в [репозитории на GitHub](ссылка).
...
Подробные результаты по каждой модели (с точными выводами, разбивкой оценок и заметками о поведении) — на GitHub: [ссылка на репозиторий]
